...
function Login() {
    ...
    return (
        <div className={` w-full min-h-screen p-3 flex justify-center items-center gap-3 bg-slate-100`}>
            ...
            <div className={` w-11/12 md:w-10/12 p-3 flex flex-col lg:flex-row gap-3 rounded-lg bg-slate-100 text-slate-800`}>

                {/* Icon div */}
                <div className=" w-full text-9xl flex justify-center items-center text-slate-800">
                    <FaUserShield/>
                </div>
