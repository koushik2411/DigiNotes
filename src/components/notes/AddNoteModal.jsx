...
function AddNoteModal({ setIsModalOpen, fetchNotes, color, setColor, theme }) {

    // const defaultColor = light ? "bg-slate-100" : "bg-slate-700";
        ...
        >
            ...
            >
                ...
                <div className=" w-full relative flex">
                    ...
                    <p 
                      className={` absolute right-1.5 top-3.5 text-xs text-center z-10 rounded ${title.length === 100 ? " font-semibold animate-bounce text-red-600" : ""}`}
                ...
                <textarea
                    ...
                    className={` h-full w-full p-2 bg-slate-50 resize-none outline-0 rounded overflow-y-auto ${theme === "light" ? "bg-slate-50 text-slate-800" : "bg-slate-800 text-slate-100"}`}
                />
                ...
                <div className=" w-full flex items-center justify-center gap-3">
                    ...
                    <button
                      ...
                      className=" p-1 w-18 bg-linear-to-b from-red-500 to-red-600 text-center text-slate-50 rounded"
                    >
                        Close
                    </button>
                </div>
